...
(assert (= ADDR!10 (mod (+ ap!<root>@6 19) prime)))
(assert (= ADDR!11 (mod (+ fp!<57=write/root> (- 5)) prime)))
(assert (= ADDR!12 (mod (+ ap!<root>@6 20) prime)))
(assert (= ADDR!13 (mod (+ fp!<57=write/root> (- 4)) prime)))
(assert (= ADDR!14 (mod (+ ap!<root>@6 21) prime)))
...
(assert (< (mod (+ ap!<root>@6 4) prime) (mod (+ ap!<root>@6 22) prime)))
(assert (and (<= pedersen!start MEM!4) (<= MEM!10 pedersen!end)))
(assert true)
(assert true)
(assert true)
(assert (and (<= MEM!11 MEM!12) (<= pedersen!start MEM!12)))
...
(assert (and (<= MEM!13 MEM!14) (<= range-check!start MEM!14)))
(assert (not (and (<= MEM!4 MEM!10) (<= pedersen!start MEM!10) (<= pedersen!start MEM!11) (<= MEM!12 pedersen!end) (<= MEM!6 MEM!12) (<= range-check!start MEM!12) (<= range-check!start MEM!13) (<= MEM!14 range-check!end) (= 42 __main__.balance))))
(check-sat)