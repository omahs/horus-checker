...
(assert (= ADDR!1 ap!<root>@5))
(assert (= ADDR!2 (mod (+ fp!<root> (- 6)) prime)))
(assert (= ADDR!3 (mod (+ ap!<root>@5 1) prime)))
(assert (= ADDR!4 (mod (+ fp!<root> (- 5)) prime)))
(assert (= ADDR!5 (mod (+ ap!<root>@5 2) prime)))
(assert (= ADDR!6 (mod (+ fp!<root> (- 4)) prime)))
(assert (= ADDR!7 (mod (+ ap!<root>@5 3) prime)))
(assert (= ADDR!8 (mod (+ ap!<root>@5 4) prime)))
(assert (= ADDR!9 (mod (+ ap!<root>@5 22) prime)))
(assert (= ADDR!10 (mod (+ ap!<root>@5 20) prime)))
(assert (= ADDR!11 (mod (+ fp!<49=read/root> (- 4)) prime)))
(assert (= ADDR!12 (mod (+ ap!<root>@5 21) prime)))
(assert (= ADDR!13 (mod (+ fp!<49=read/root> (- 3)) prime)))
(assert (<= fp!<root> ap!<root>@5))
(assert (= ap!<root>@5 fp!<root>))
(assert (= MEM!2 MEM!1))
(assert (= MEM!4 MEM!3))
(assert (= MEM!6 MEM!5))
(assert (and (= fp!<49=read/root> (mod (+ ap!<root>@5 5) prime)) (= MEM!7 fp!<root>) (= MEM!8 51)))
(assert true)
...
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 6)) prime)) (< (mod (+ fp!<root> (- 6)) prime) range-check!end)) (<= 0 MEM!2 (mod (+ range-check-bound (- 1)) prime))))
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 5)) prime)) (< (mod (+ fp!<root> (- 5)) prime) range-check!end)) (<= 0 MEM!4 (mod (+ range-check-bound (- 1)) prime))))
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 4)) prime)) (< (mod (+ fp!<root> (- 4)) prime) range-check!end)) (<= 0 MEM!6 (mod (+ range-check-bound (- 1)) prime))))
(assert (and (<= MEM!13 MEM!12) (<= range-check!start MEM!12)))
(assert (not (and (<= MEM!4 MEM!10) (<= pedersen!start MEM!10) (<= pedersen!start MEM!11) (<= MEM!10 pedersen!end) (<= MEM!6 MEM!12) (<= range-check!start MEM!12) (<= range-check!start MEM!13) (<= MEM!12 range-check!end))))
(check-sat)