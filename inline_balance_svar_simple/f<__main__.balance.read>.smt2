...
(assert (= ADDR!9 (mod (+ ap!<root>@5 20) prime)))
(assert (= ADDR!10 (mod (+ fp!<49=read/root> (- 4)) prime)))
(assert (= ADDR!11 (mod (+ ap!<root>@5 21) prime)))
(assert (= ADDR!12 (mod (+ fp!<49=read/root> (- 3)) prime)))
