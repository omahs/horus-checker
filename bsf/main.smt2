...
(assert true)
(assert (and (<= bitwise!start MEM!22) (<= MEM!21 bitwise!end)))
(assert true)
(assert true)
(assert true)
(assert true)
...
(assert true)
(assert true)
(assert (and (<= MEM!9 MEM!13) (<= bitwise!start MEM!13)))
(assert true)
(assert true)
(assert true)
(assert true)
(assert (not (and (<= MEM!22 MEM!21) (<= bitwise!start MEM!21) (<= bitwise!start MEM!9) (<= MEM!13 bitwise!end))))
(check-sat)