...
(assert (= ADDR!10 (mod (+ fp!<12=apply_bitwise/root> (- 5)) prime)))
...
(assert (and (<= bitwise!start MEM!2) (<= MEM!9 bitwise!end)))
(assert true)
(assert true)
(assert (and (<= MEM!10 MEM!9) (<= bitwise!start MEM!9)))
(assert (not (and (<= MEM!2 MEM!9) (<= bitwise!start MEM!9) (<= bitwise!start MEM!10) (<= MEM!9 bitwise!end))))
(check-sat)