...
(declare-fun fp!<13=apply_bitwise/root> () Int)
...
(assert (and (<= 0 fp!<13=apply_bitwise/root>) (< fp!<13=apply_bitwise/root> prime)))
...
(assert (= ADDR!3 (mod (+ ap!<root>@1 2) prime)))
(assert (= ADDR!4 (mod (+ fp!<root> (- 3)) prime)))
(assert (= ADDR!5 (mod (+ ap!<root>@1 3) prime)))
(assert (= ADDR!6 (mod (+ ap!<root>@1 4) prime)))
(assert (= ADDR!7 (mod (+ fp!<13=apply_bitwise/root> (- 4)) prime)))
(assert (= ADDR!8 (mod (+ ap!<root>@1 9) prime)))
(assert (= ADDR!9 (mod (+ fp!<root> (- 4)) prime)))
(assert (= ADDR!10 (mod (+ ap!<root>@1 10) prime)))
(assert (= ADDR!11 (mod (+ ap!<root>@1 6) prime)))
(assert (= ADDR!12 (mod (+ ap!<root>@1 11) prime)))
(assert (= ADDR!13 (mod (+ ap!<root>@1 7) prime)))
(assert (= ADDR!14 (mod (+ ap!<root>@1 12) prime)))
(assert (= ADDR!15 (mod (+ ap!<root>@1 8) prime)))
(assert (= ADDR!16 (mod (+ fp!<13=apply_bitwise/root> (- 5)) prime)))
(assert (= ADDR!17 (mod (+ ap!<root>@1 5) prime)))
(assert (<= fp!<root> ap!<root>@1))
(assert (= ap!<root>@1 fp!<root>))
(assert (= 42 MEM!1))
(assert (= 24601 MEM!2))
(assert (= MEM!4 MEM!3))
(assert (and (= fp!<13=apply_bitwise/root> (mod (+ ap!<root>@1 5) prime)) (= MEM!5 fp!<root>) (= MEM!6 15)))
(assert (= 24601 MEM!7))
(assert true)
(assert (= MEM!9 MEM!8))
...
(assert true)
(assert (and (<= bitwise!start MEM!9) (<= MEM!8 bitwise!end)))
(assert true)
(assert (and (<= MEM!16 MEM!17) (<= bitwise!start MEM!17)))
(assert true)
(assert true)
(assert true)
(assert true)
(assert (not (and (<= MEM!9 MEM!8) (<= bitwise!start MEM!8) (<= bitwise!start MEM!16) (<= MEM!17 bitwise!end))))
(check-sat)