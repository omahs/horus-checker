...
(assert (= ADDR!10 (mod (+ fp!<13=apply_bitwise/root> (- 5)) prime)))
...
(assert (and (<= bitwise!start MEM!8) (<= MEM!9 bitwise!end)))
(assert true)
(assert (not (and (= 24601 MEM!7) (<= bitwise!start MEM!10) (<= MEM!9 bitwise!end))))
(check-sat)