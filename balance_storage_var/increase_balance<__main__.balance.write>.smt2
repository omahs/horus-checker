...
(assert (= ADDR!20 (mod (+ ap!<root>@5 43) prime)))
(assert (= ADDR!21 (mod (+ fp!<49=read/root> (- 4)) prime)))
(assert (= ADDR!22 (mod (+ fp!<55=write/root> (- 5)) prime)))
(assert (= ADDR!23 (mod (+ ap!<root>@5 44) prime)))
(assert (= ADDR!24 (mod (+ fp!<49=read/root> (- 3)) prime)))
(assert (= ADDR!25 (mod (+ fp!<55=write/root> (- 4)) prime)))
...
(assert (and (<= pedersen!start MEM!5) (<= MEM!20 pedersen!end)))
(assert true)
(assert true)
(assert true)
(assert (and (<= MEM!21 MEM!14) (<= pedersen!start MEM!14)))
(assert true)
(assert true)
(assert true)
(assert (=> (or (<= pedersen!start MEM!10) (<= pedersen!start MEM!1)) (= (+ MEM!10 MEM!1) (mod (+ MEM!10 MEM!1) prime))))
(assert (and (<= range-check!start MEM!7) (<= MEM!23 range-check!end)))
...
(assert (and (<= MEM!24 MEM!16) (<= range-check!start MEM!16)))
...
(assert (not (and (<= pedersen!start MEM!21) (<= MEM!14 pedersen!end) (<= pedersen!start MEM!22) (<= MEM!20 pedersen!end) (<= range-check!start MEM!24) (<= MEM!16 range-check!end) (<= range-check!start MEM!25) (<= MEM!23 range-check!end))))
(check-sat)