...
(declare-fun fp!<61=read/root> () Int)
...
(assert (and (<= 0 fp!<61=read/root>) (< fp!<61=read/root> prime)))
...
(assert (= ADDR!10 (mod (+ fp!<61=read/root> (- 4)) prime)))
(assert (= ADDR!11 (mod (+ ap!<root>@6 21) prime)))
(assert (= ADDR!12 (mod (+ fp!<61=read/root> (- 3)) prime)))
(assert (<= fp!<root> ap!<root>@6))
(assert (= ap!<root>@6 fp!<root>))
(assert (= MEM!2 MEM!1))
(assert (= MEM!4 MEM!3))
(assert (= MEM!6 MEM!5))
(assert (and (= fp!<61=read/root> (mod (+ ap!<root>@6 5) prime)) (= MEM!7 fp!<root>) (= MEM!8 63)))
...
(assert (not (and (<= pedersen!start MEM!10) (<= MEM!9 pedersen!end) (<= range-check!start MEM!12) (<= MEM!11 range-check!end))))
(check-sat)