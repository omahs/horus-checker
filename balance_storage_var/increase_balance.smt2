...
(declare-fun fp!<49=read/root> () Int)
(declare-fun fp!<55=write/root> () Int)
...
(assert (and (<= 0 fp!<49=read/root>) (< fp!<49=read/root> prime)))
(assert (and (<= 0 fp!<55=write/root>) (< fp!<55=write/root> prime)))
...
(assert (= ADDR!2 ap!<root>@5))
(assert (= ADDR!3 (mod (+ fp!<root> (- 6)) prime)))
(assert (= ADDR!4 (mod (+ ap!<root>@5 1) prime)))
(assert (= ADDR!5 (mod (+ fp!<root> (- 5)) prime)))
(assert (= ADDR!6 (mod (+ ap!<root>@5 2) prime)))
(assert (= ADDR!7 (mod (+ fp!<root> (- 4)) prime)))
(assert (= ADDR!8 (mod (+ ap!<root>@5 3) prime)))
(assert (= ADDR!9 (mod (+ ap!<root>@5 4) prime)))
(assert (= ADDR!10 (mod (+ ap!<root>@5 22) prime)))
(assert (= ADDR!11 (mod (+ ap!<root>@5 23) prime)))
(assert (= ADDR!12 (mod (+ ap!<root>@5 19) prime)))
...
(assert (= ADDR!18 (mod (+ ap!<root>@5 27) prime)))
(assert (= ADDR!19 (mod (+ ap!<root>@5 28) prime)))
(assert (= ADDR!20 (mod (+ fp!<55=write/root> (- 3)) prime)))
(assert (= ADDR!21 (mod (+ ap!<root>@5 43) prime)))
(assert (= ADDR!22 (mod (+ fp!<49=read/root> (- 4)) prime)))
(assert (= ADDR!23 (mod (+ fp!<55=write/root> (- 5)) prime)))
(assert (= ADDR!24 (mod (+ ap!<root>@5 44) prime)))
(assert (= ADDR!25 (mod (+ fp!<49=read/root> (- 3)) prime)))
(assert (= ADDR!26 (mod (+ fp!<55=write/root> (- 4)) prime)))
(assert (<= fp!<root> ap!<root>@5))
(assert (= ap!<root>@5 fp!<root>))
(assert (= MEM!3 MEM!2))
(assert (= MEM!5 MEM!4))
(assert (= MEM!7 MEM!6))
(assert (and (= fp!<49=read/root> (mod (+ ap!<root>@5 5) prime)) (= MEM!8 fp!<root>) (= MEM!9 51)))
(assert true)
(assert (= MEM!10 __main__.balance))
(assert (= MEM!12 MEM!11))
(assert (= MEM!14 MEM!13))
(assert (= MEM!16 MEM!15))
(assert (= (mod (+ MEM!10 MEM!1) prime) MEM!17))
(assert (and (= fp!<55=write/root> (mod (+ ap!<root>@5 29) prime)) (= MEM!18 fp!<root>) (= MEM!19 57)))
(assert true)
(assert true)
(assert (< (mod (+ ap!<root>@5 27) prime) (mod (+ ap!<root>@5 45) prime)))
(assert (and (<= pedersen!start MEM!5) (<= MEM!21 pedersen!end)))
(assert true)
(assert true)
(assert true)
(assert (and (<= MEM!22 MEM!14) (<= pedersen!start MEM!14)))
(assert true)
(assert true)
(assert true)
(assert (=> (or (<= pedersen!start MEM!10) (<= pedersen!start MEM!1)) (= (+ MEM!10 MEM!1) (mod (+ MEM!10 MEM!1) prime))))
(assert (and (<= MEM!23 MEM!21) (<= pedersen!start MEM!21)))
(assert (and (<= range-check!start MEM!7) (<= MEM!24 range-check!end)))
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 6)) prime)) (< (mod (+ fp!<root> (- 6)) prime) range-check!end)) (<= 0 MEM!3 (mod (+ range-check-bound (- 1)) prime))))
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 5)) prime)) (< (mod (+ fp!<root> (- 5)) prime) range-check!end)) (<= 0 MEM!5 (mod (+ range-check-bound (- 1)) prime))))
(assert (=> (and (<= range-check!start (mod (+ fp!<root> (- 4)) prime)) (< (mod (+ fp!<root> (- 4)) prime) range-check!end)) (<= 0 MEM!7 (mod (+ range-check-bound (- 1)) prime))))
(assert (and (<= MEM!25 MEM!16) (<= range-check!start MEM!16)))
(assert (=> (and (<= range-check!start (mod (+ ap!<root>@5 19) prime)) (< (mod (+ ap!<root>@5 19) prime) range-check!end)) (<= 0 MEM!12 (mod (+ range-check-bound (- 1)) prime))))
...
(assert (=> (or (<= range-check!start MEM!10) (<= range-check!start MEM!1)) (= (+ MEM!10 MEM!1) (mod (+ MEM!10 MEM!1) prime))))
(assert (and (<= MEM!26 MEM!24) (<= range-check!start MEM!24)))
(assert (not (and (<= MEM!5 MEM!21) (<= pedersen!start MEM!21) (<= pedersen!start MEM!22) (<= MEM!14 pedersen!end) (<= pedersen!start MEM!23) (<= MEM!21 pedersen!end) (<= MEM!7 MEM!24) (<= range-check!start MEM!24) (<= range-check!start MEM!25) (<= MEM!16 range-check!end) (<= range-check!start MEM!26) (<= MEM!24 range-check!end) (= MEM!20 (mod (+ __main__.balance MEM!1) prime)) (= (mod (+ __main__.balance MEM!1) prime) MEM!20))))
(check-sat)